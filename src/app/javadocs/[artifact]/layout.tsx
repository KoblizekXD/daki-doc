    ...
    return (
      <main className='flex bg-[linear-gradient(to_right,#4f4f4f2e_1px,transparent_1px),linear-gradient(to_bottom,#8080800a_1px,transparent_1px)] bg-[size:14px_24px] items-center gap-x-2 justify-center min-h-screen'>
        ...
        <div className='flex flex-col'>
          ...
          <Link
            className='text-3xl gap-x-3 text-muted-foreground flex items-center font-bold'
            href={'/'}>
            Home
  ...
  return (
    <main className='flex flex-col min-h-screen'>
      <Navbar className='py-2'>
        ...
        <Link
          target='_blank'
          href={`https://mvnrepository.com/artifact/${artifact.replaceAll(':', '/')}`}
          className='ml-auto text-sm flex select-none cursor-pointer hover:bg-muted transition-colors items-center gap-x-2 rounded p-1'>
